...
public class Insert extends ObjConv {
    ...
    public Insert(@NotNull String tableName, @NotNull Map<String, String> defaultValues) {
        this.tableName = tableName;
    ...
    public String build(boolean force) {
        ...
        result.append("INSERT").append(force?"": SQLow.getDatabaseType()!=DatabaseType.SQLITE?" IGNORE":" OR IGNORE").append(" INTO ")
                .append(tableName)
